...
% Nakano's 2-point method for F+f estimation with two known epipoles
%
% USAGE:
%   [F, f, E] = Ff2pt_e1e2_Nakano(e1, e2, m1, m2, c1, c2)
% INPUTS:
...
function [F, f, E] = Ff2pt_e1e2_Nakano(e1, e2, m1, m2, c1, c2)
arguments 
    e1 (3,1) double
    e2 (3,1) double
    m1 (3,2) double
